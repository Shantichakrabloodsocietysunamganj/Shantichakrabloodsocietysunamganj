...
- **সেবা হাব** (`/services`) — সব পাবলিক সেবা এক জায়গায়, সার্চ ও ক্যাটাগরি ফিল্টারসহ
- **রক্ত সামঞ্জস্যতা** (`/compatibility`) — গ্রুপ বেছে নিলে কাকে দিতে/কার কাছ থেকে নিতে পারেন, পূর্ণ সারণি ও মিলিয়ে দাতা খোঁজা
- **রক্তদান গাইড** (`/guide`) — আগে/দিনে/পরে চেকলিস্ট, খাবার নির্দেশনা ও পরবর্তী যোগ্য তারিখ ক্যালকুলেটর
- **অনুরোধ ট্র্যাক** (`/track`) — রোগীর নাম, হাসপাতাল বা আইডি দিয়ে স্ট্যাটাস (ফোন নম্বর সার্চযোগ্য নয়)
- **SOS শেয়ার** (`/sos`) — WhatsApp / SMS / Facebook-এর জন্য প্রস্তুত জরুরি বার্তা
- **দ্রুত সহায়তা উইজার্ড** (`/match`) — ৩টি প্রশ্নে সঠিক সেবায় পৌঁছানো
- **কমান্ড প্যালেট** (`Ctrl+K`) — যেকোনো সেবা বা রক্তের গ্রুপ মুহূর্তে খুঁজে যাওয়া
