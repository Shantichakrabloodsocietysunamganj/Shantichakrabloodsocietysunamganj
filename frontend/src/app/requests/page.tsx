  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        setError(e?.message ?? "অনুরোধ তালিকা আনা যায়নি");
      } finally {
        setLoading(false);
      }
    })();
    ...
    <div className="container-page py-10">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div className="max-w-xl">
          <h1 className="text-3xl font-bold tracking-tight text-zinc-900">জরুরি রক্তের অনুরোধ</h1>
          <p className="mt-2 text-zinc-600">
            সুনামগঞ্জ জুড়ে সাহায্যের অপেক্ষায় থাকা রোগীদের তালিকা। সাহায্য করতে পারলে সরাসরি যোগাযোগ করুন।
          </p>
        </div>
        <Link href="/request-blood" className="btn-primary shrink-0">+ নতুন অনুরোধ</Link>
      </header>
      ...
      <div className="mt-8">
        {error ? (
          <div className="card p-10 text-center text-zinc-500">
            <p className="font-medium text-zinc-700">⚠️ তালিকা আনা যায়নি</p>
          ...
          <div className="card p-12 text-center">
            ...
            <p className="mt-1 text-sm text-zinc-500">সবাই নিরাপদে আছেন।</p>
          </div>
        ) : (
