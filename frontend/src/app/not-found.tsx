    ...
    <div className="container-page relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden py-20 text-center">
      ...
      <div className="relative">
        <p className="font-display text-[7rem] font-extrabold leading-none tracking-tighter">
          <span className="bg-gradient-to-br from-brand-600 to-blood-600 bg-clip-text text-transparent">{tx("৪০৪")}</span>
        </p>
        ...
        <h1 className="mt-6 font-display text-2xl font-extrabold tracking-tight text-ink">{tx("পেজ পাওয়া যায়নি")}</h1>
